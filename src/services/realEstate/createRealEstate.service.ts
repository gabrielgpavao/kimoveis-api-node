...
import { tRealEstateRepo, tInputRealEstateData, tOutputRealEstateData } from '../../interfaces/realEstates/realEstates.interfaces';
import { outputRealEstateDataSchema } from '../../schemas/realEstate.schemas';
import { createAddressService } from './createAddress.service';

export async function createRealEstateService (realEstateData: tInputRealEstateData): Promise<tOutputRealEstateData> {
